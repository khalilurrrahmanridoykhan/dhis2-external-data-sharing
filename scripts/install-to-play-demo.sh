...
echo
echo "The app's launch URL is normally: ${BASE_URL}/apps/external-data-sharing"
echo "(no trailing slash -- with one it 302s back to itself). Confirm with:"
echo "  curl -I -u \"\$PLAY_USERNAME:\$PLAY_PASSWORD\" \"${BASE_URL}/apps/external-data-sharing\""
