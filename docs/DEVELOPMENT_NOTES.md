...
These notes record decisions when they were made. Where behaviour has since
changed, the README describes the current behaviour. For example, revoking a
share no longer always disables the account, and a share can now be attached
